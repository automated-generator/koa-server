...
exports.Typescript = {
    ...
    instances: async (t) => {
        ...
        try {
            ...
            t.same(err.message, 'Class is not extended properly. Use the return Nohm.register() instead of your class directly.', 'Directly constructing a class did not throw the correct error.');
        }
    ...
    'validation errors': async (t) => {
        ...
        try {
            ...
            if (err instanceof _1.ValidationError && err.modelName === 'UserMockup') {
                t.same(err.errors.name, [
                    'notEmpty',
                ]);
            }
            else {
